        ...
        ">
            ...
            <div className="hidden md:flex gap-8 tex-sm font-mono text-cyan-500/70">
                <div className="flex flex-col items-end">
                    <span className="text-[10px] uppercase opacity-50">Nascimento</span>
                    <span className="text-cyan-200">{data.birth_year}</span>
                </div>

                <div className="flex flex-col items-end w-24">
                    <span className="text-[10px] uppercase opacity-50">Gênero</span>
                    <span className="capitalize text-cyan-200">{data.gender}</span>
                </div>
            </div>
        </li>
    );
